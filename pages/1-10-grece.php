<section class="section grece" data-anchor="<?= $anchor ?>" data-background="bg-grece.jpg" data-play="2">
	<div class="container medium" style="background-color: rgba(17, 12, 8, .7);">
		        <header>
		            <h2>Moussaka</h2>
		            <div class="stamp">
		                <span><i class="icon-map-signs"></i> Planification</span>
		                <span><i class="icon-marker"></i> Stavros, Grêce</span>
		        ...
		        <p>J'ai trois visas en poche pour mener à bien mon voyage :</p>
						<ul>
							...
							<li>Tadjikistan du 10 juin au 9 juillet</li>
							<li>Russie du 1er juillet au 30 juillet</li>
						</ul>
