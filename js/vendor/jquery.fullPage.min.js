    ...
    $.fn.fullpage = function(options) {
        ...
        */
        ...
        function activateNavDots(name, sectionIndex){
            // if(options.navigation){
                $('.chapitres').find(ACTIVE_SEL).removeClass(ACTIVE);
                if(name){
                    $('.chapitres').find('a[href="#' + name + '"]').addClass(ACTIVE);
                }else{
                    $('.chapitres').find('li').eq(sectionIndex).find('a').addClass(ACTIVE);
                }
            // }
        }
